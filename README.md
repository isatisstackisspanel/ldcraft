کانال یوتوب : [https://www.youtube.com/@Arian_LD](https://www.youtube.com/@Arian_LD)
...
| متغیر                   | توضیح                                                                      | پیش‌فرض     |
| ----------------------- | -------------------------------------------------------------------------- | ----------- |
| `ADMIN_PASSWORD`        | رمز عبور ورود به داشبورد وب                                                | `ldcraft`   |
...
ldcraft · پشتیبانی: [لینک گروه](https://t.me/Arian_LD)
